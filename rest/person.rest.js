...
const PATH = 'person';
function setup() {
    server_1.app.get(`/${PATH}/actors`, (0, middleware_config_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
        const name = req.query.name;
        const result = yield TheMovieDbService.doSearchPerson(name);
        res.json(filterPersons(result, 'Acting'));
    })));
    server_1.app.get(`/${PATH}/directors`, (0, middleware_config_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
        const name = req.query.name;
        const result = yield TheMovieDbService.doSearchPerson(name);
...
function filterPersons(persons, by) {
    return persons.filter(person => {
        assert_1.default.ok(person.popularity);
